...
Title                   : tdirlevel.gob
File Name               : TDIRLEVEL.ZIP
File Size               :  6.89 mb
Author(s)               : Shred18, Hell Raiser, ctsketch 
Date of Release         : May 2003

Email Address           : Shred18@yahoo.com 
Misc. Author Info       : 

Description             : Base levels for TDIR. Hell by ctsketch, with modified sky by Shred, the rest by Shred. Cogs by Hell raiser.

Additional Credits to   : Madeventnor, Ped Head, Variouse other artist's textures I've used (sorry I can't remember your names, it's been 3 years)

Beta Testers            : RiViN, Raziel, BackSlash, Vash, Cougar_Boy, sdrawkcaB. 

Development machine     : PIII with 912MB RAM
Machine(s) tested on    : various 
================================================================

* Play Information *

Episode name            : TDIR Level
Level name(s)           : namek waters, hell, snakeway, kamis lookout, tree of might, supreme kai's planet, roshi's island, battleground namek.
...
Editor(s) used          : JED
Known Bugs              : The minigame in roshis would not work right, therefore it will be disabled. JK draw dinstance is only so far, so you will experience sky clipping in battleground namek.
